...
(function () {
  ...
  function openPanel() {
    ...
    var panel = document.getElementById("lvc-panel") || buildPanel();
  ...
  function poll() {
    ...
    request("GET", "/conversation?after=" + lastId)
  ...
  function injectStyles() {
    ...
    var css =
      ...
      ".lvc-greeting{color:var(--lvc-muted);font-size:13px;margin-bottom:8px}" +
      ".lvc-who{font-size:11px;color:var(--lvc-muted);margin:8px 4px 2px}" +
      ".lvc-who-visitor{text-align:right}" +
      "#lvc-root[dir=rtl] .lvc-who-visitor{text-align:left}" +
      ".lvc-msg{max-width:82%;padding:8px 12px;border-radius:14px;white-space:pre-wrap;" +
      "overflow-wrap:anywhere;font-size:14px}" +
      ".lvc-visitor{align-self:flex-end;background:var(--lvc-accent);color:var(--lvc-accent-text);" +
      "border-bottom-right-radius:4px}" +
      "#lvc-root[dir=rtl] .lvc-visitor{align-self:flex-start;border-bottom-right-radius:14px;" +
      "border-bottom-left-radius:4px}" +
      ".lvc-agent{align-self:flex-start;background:var(--lvc-surface);border:1px solid var(--lvc-border);" +
      "border-bottom-left-radius:4px}" +
      "#lvc-root[dir=rtl] .lvc-agent{align-self:flex-end;border-bottom-left-radius:14px;" +
      "border-bottom-right-radius:4px}" +
      ".lvc-system{align-self:center;color:var(--lvc-muted);font-size:12px;margin:8px 0}" +
      ...
      "color:var(--lvc-accent-text);padding:8px 14px;font:inherit;font-weight:600;cursor:pointer}" +
